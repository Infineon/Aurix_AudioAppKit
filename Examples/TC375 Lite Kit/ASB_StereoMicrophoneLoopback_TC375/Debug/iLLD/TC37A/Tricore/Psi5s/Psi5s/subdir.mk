...
C_SRCS += \
../iLLD/TC37A/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.c 

OBJS += \
./iLLD/TC37A/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.o 

COMPILED_SRCS += \
./iLLD/TC37A/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.src 

C_DEPS += \
./iLLD/TC37A/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.d 


# Each subdirectory must supply rules for building sources it contributes
iLLD/TC37A/Tricore/Psi5s/Psi5s/%.src: ../iLLD/TC37A/Tricore/Psi5s/Psi5s/%.c
	@echo 'Building file: $<'
...
iLLD/TC37A/Tricore/Psi5s/Psi5s/%.o: ./iLLD/TC37A/Tricore/Psi5s/Psi5s/%.src
	@echo 'Building file: $<'
