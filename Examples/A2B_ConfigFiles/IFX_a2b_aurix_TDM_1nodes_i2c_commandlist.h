...
* @version: $Revision$
* @date: Thursday, November 16, 2023-6:43:38 PM
...
static unsigned char gaConfig_AD242xSlaveNode0_LDNSLOTS_Data3[1] =
{
	0x80u	
};

static unsigned char gaConfig_AD242xSlaveNode0_LUPSLOTS_Data4[1] =
{
	0x04u	
};

static unsigned char gaConfig_AD242xSlaveNode0_PDMCTL_Data5[1] =
{
	0x0Fu	
};

static unsigned char gaConfig_AD242xSlaveNode0_CLK2CFG_Data6[1] =
{
	0x81u	
};

static unsigned char gaConfig_AD242xSlaveNode0_MBOX1CTL_Data7[1] =
{
	0x00u	
};

static unsigned char gaConfig_AD242xSlaveNode0_INTMSK0_Data8[1] =
{
	0x10u	
};

static unsigned char gaConfig_AD242xMasterNode0_I2SCFG_Data17[1] =
{
	0x01u	
};

static unsigned char gaConfig_AD242xMasterNode0_PDMCTL_Data18[1] =
{
	0x0Au	
};

static unsigned char gaConfig_AD242xMasterNode0_PDMCTL2_Data19[1] =
{
	0x08u	
};

static unsigned char gaConfig_AD242xMasterNode0_UPSLOTS_Data20[1] =
{
	0x04u	
};

static unsigned char gaConfig_AD242xMasterNode0_SWCTL_Data21[1] =
{
	0x01u	
};
...
static unsigned char gaConfig_AD242xMasterNode0_SLOTFMT_Data24[1] =
{
	0x44u	
};

static unsigned char gaConfig_AD242xMasterNode0_DATCTL_Data25[1] =
{
	0x03u	
};

static unsigned char gaConfig_AD242xMasterNode0_CONTROL_Data26[1] =
{
	0x81u	
};

static unsigned char gaConfig_AD242xMasterNode0_A2BDelay_Data27[1] =
{
	0x01u	
};
...
static unsigned char gaConfig_AD242xMasterNode0_CONTROL_Data29[1] =
{
	0x82u	
};
...
ADI_A2B_DISCOVERY_CONFIG gaA2BConfig[CONFIG_LEN] =
{
	...
	/*-- COMMANDS FOR DEVICE - AD242x Slave Node0 --*/
	{0x69u,	WRITE,	0x01u,	0x0000000Bu,	0x01u,	0x0001u,	&gaConfig_AD242xSlaveNode0_LDNSLOTS_Data3[0] },	/* LDNSLOTS */
	{0x69u,	WRITE,	0x01u,	0x0000000Cu,	0x01u,	0x0001u,	&gaConfig_AD242xSlaveNode0_LUPSLOTS_Data4[0] },	/* LUPSLOTS */
	{0x69u,	WRITE,	0x01u,	0x00000047u,	0x01u,	0x0001u,	&gaConfig_AD242xSlaveNode0_PDMCTL_Data5[0] },	/* PDMCTL */
	{0x69u,	WRITE,	0x01u,	0x0000005Au,	0x01u,	0x0001u,	&gaConfig_AD242xSlaveNode0_CLK2CFG_Data6[0] },	/* CLK2CFG */
	{0x69u,	WRITE,	0x01u,	0x00000096u,	0x01u,	0x0001u,	&gaConfig_AD242xSlaveNode0_MBOX1CTL_Data7[0] },	/* MBOX1CTL */
	{0x69u,	WRITE,	0x01u,	0x0000001Bu,	0x01u,	0x0001u,	&gaConfig_AD242xSlaveNode0_INTMSK0_Data8[0] },	/* INTMSK0 */

	/*-- COMMANDS FOR DEVICE - AD242x Master Node0 --*/
	{0x68u,	WRITE,	0x01u,	0x00000042u,	0x01u,	0x0001u,	&gaConfig_AD242xMasterNode0_I2SCFG_Data17[0] },	/* I2SCFG */
	{0x68u,	WRITE,	0x01u,	0x00000047u,	0x01u,	0x0001u,	&gaConfig_AD242xMasterNode0_PDMCTL_Data18[0] },	/* PDMCTL */
	{0x68u,	WRITE,	0x01u,	0x0000005Du,	0x01u,	0x0001u,	&gaConfig_AD242xMasterNode0_PDMCTL2_Data19[0] },	/* PDMCTL2 */
	{0x68u,	WRITE,	0x01u,	0x0000000Eu,	0x01u,	0x0001u,	&gaConfig_AD242xMasterNode0_UPSLOTS_Data20[0] },	/* UPSLOTS */
	{0x68u,	WRITE,	0x01u,	0x00000009u,	0x01u,	0x0001u,	&gaConfig_AD242xMasterNode0_SWCTL_Data21[0] },	/* SWCTL */
	...
	{0x68u,	WRITE,	0x01u,	0x00000010u,	0x01u,	0x0001u,	&gaConfig_AD242xMasterNode0_SLOTFMT_Data24[0] },	/* SLOTFMT */
	{0x68u,	WRITE,	0x01u,	0x00000011u,	0x01u,	0x0001u,	&gaConfig_AD242xMasterNode0_DATCTL_Data25[0] },	/* DATCTL */
	{0x68u,	WRITE,	0x01u,	0x00000012u,	0x01u,	0x0001u,	&gaConfig_AD242xMasterNode0_CONTROL_Data26[0] },	/* CONTROL */
	{0x00u,	DELAY,	0x01u,	0x00000000u,	0x01u,	0x0001u,	&gaConfig_AD242xMasterNode0_A2BDelay_Data27[0] },	/* A2B_Delay */
	{0x68u,	WRITE,	0x01u,	0x00000001u,	0x01u,	0x0001u,	&gaConfig_AD242xMasterNode0_NODEADR_Data28[0] },	/* NODEADR */
	{0x68u,	WRITE,	0x01u,	0x00000012u,	0x01u,	0x0001u,	&gaConfig_AD242xMasterNode0_CONTROL_Data29[0] },	/* CONTROL */
};
